...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[url('/logIn.jpg')] bg-center bg-cover shadow-md bg-bottom bg-gray-100">
      <div className="max-w-[400px] p-8 rounded-lg backdrop-blur-lg  hover:shadow-[0_0_40px_rgba(59,130,246,0.8)]  bg-[linear-gradient(to_right,rgba(41, 0, 105, 0.7),rgba(34, 105, 220, 0.7))]">
